      ...
      child: Stack(
        ...
        children: [
          Positioned(
            ...
            child: Expanded(
              child: SizedBox(
                //todo fix the error of unbounded width here. replace the temporary fix
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        //     ),
                        //   ), //todo change the listTile to custom row implementation of desired design.
                        // ),
                        // Expanded(
                        //   child: ListTile(
                        //     leading: SizedBox(
                        //         height: MediaQuery.sizeOf(context).height / 5,
                        //         width: MediaQuery.sizeOf(context).width / 5,
                        //         child: Image.asset('assets/work_2.png')),
                        //     title: const Text('Graphic Design'),
                        //     subtitle: const Text(
                        //         'New & Fresh Looking Portfolio indeed at the end'),
                        //   ),
